...
;(function ( $, window, document, undefined ) {
                        ...
                        container.append(
                            $("<" + options.item + ">", {
                                ...
                                attr: ( page == i ) ? options.attrItemActive : {},
                                		//修改，重点突出选中分页数
                                "class": pluginName + "-page "+(( page == i ) ? "active" : "")
                            })
                            .append(
    ...
    Plugin.prototype = {
        ...
        renderPager: function( total ) {
            this.$el.prepend( this.getPager( this._params[ this.settings.paramsMapping.page ], Math.ceil( total / this._params[ this.settings.paramsMapping.paging ] ) ) );
