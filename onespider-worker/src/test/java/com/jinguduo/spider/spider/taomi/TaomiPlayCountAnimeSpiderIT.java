...
public class TaomiPlayCountAnimeSpiderIT {

    @Autowired
    private TaomiPlayCountAnimeSpider taomiAnimeSpider;
    ...
    public void testProcessNewMovie()  {
        ...
        Job j = new Job("http://vapp.61.com/api.php?method=api.Score.getVideoInfo&vid=10224");
        j.setPlatformId(1);
        j.setShowId(1);
