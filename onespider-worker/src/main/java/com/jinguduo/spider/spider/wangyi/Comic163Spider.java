 ...
 * 版权所有：北京金骨朵文化传播有限公司
 *
 * @deprecated  该爬虫已经过期 ComicBilibiliSpider
 *
 * @DATE  01/06/2020 11:40
 */
//@Worker
@Deprecated
public class Comic163Spider extends CrawlSpider {

    // https://manhua.163.com
    private Site site = SiteBuilder.builder().setDomain("manhua.163.com").build();

    private PageRule rules = PageRule.build()
            .add("manhua.163.com$", page -> processHome(page))
            .add("category", page -> processPager(page)) // https://manhua.163.com/category/getData.json?sort=2&pageSize=72&page=1
    ...
    private final String PAGE_URL = "https://manhua.163.com/category/getData.json?sort=2&dq=0&pageSize=72&page=%s";

    private final String B_URL = "https://manhua.163.com/source/%s";

    private final String AUTHOR_URL = "https://manhua.163.com/author/book/%s";
