...
@WebAppConfiguration
@ActiveProfiles("test")
public class WeiboFeedKeywordLogControllerTests {

	private MockMvc mockMvc;

	@Resource
	private WeiboFeedKeywordLogController controller;
	...
	public void testPost() throws Exception {
		...
		WeiboFeedKeywordLog[] logs = new WeiboFeedKeywordLog[10];
		for (int i = 0; i < logs.length; i++) {
		    WeiboFeedKeywordLog d = new WeiboFeedKeywordLog();
		    d.setKeyword("k" + i);
		    d.setDay(new Date(System.currentTimeMillis()));
		    d.setFeedCount(i + 1000);
		    logs[i] =  d;
        }
